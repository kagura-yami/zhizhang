...
const createStyles = (colors: ThemeColors) => ({
  ...StyleSheet.create({
    ...
    option: { flex: 1, alignItems: 'center', paddingVertical: spacing.sm, borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.divider, backgroundColor: colors.background },
    choiceGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.sm },
    choiceOption: { width: '48%', minHeight: 44, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.sm, paddingHorizontal: spacing.xs, borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.divider, backgroundColor: colors.background },
    ...
    sortableRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center', paddingVertical: spacing.sm, paddingHorizontal: spacing.sm, borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.divider, backgroundColor: colors.background },
    ...
    sortableEmpty: { paddingVertical: spacing.md, paddingHorizontal: spacing.sm, borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.divider, borderStyle: 'dashed', backgroundColor: colors.background },
    ...
    importSoundButton: { marginTop: spacing.sm, borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.small, paddingVertical: spacing.sm, alignItems: 'center', backgroundColor: colors.background },
    ...
    soundItem: { flexDirection: 'row', alignItems: 'center', padding: spacing.sm, borderRadius: borderRadius.small, backgroundColor: colors.background, borderWidth: borderWidth.thin, borderColor: colors.divider, gap: spacing.xs },
    ...
    soundAction: { borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.small, paddingVertical: spacing.xs, paddingHorizontal: spacing.sm },
    ...
    editorCard: { backgroundColor: colors.surface, borderRadius: borderRadius.card, padding: spacing.lg, borderWidth: borderWidth.thin, borderColor: colors.divider },
    ...
    secondsInput: { borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.small, paddingVertical: spacing.sm, paddingHorizontal: spacing.sm, color: colors.textPrimary, backgroundColor: colors.background },
    editorActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: spacing.sm, marginTop: spacing.lg },
    cancelButton: { borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.small, paddingVertical: spacing.sm, paddingHorizontal: spacing.md },
