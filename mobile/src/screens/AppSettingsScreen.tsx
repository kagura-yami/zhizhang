...
const createStyles = (colors: ThemeColors) => ({
  ...StyleSheet.create({
    ...
    item: { flexDirection: 'row', alignItems: 'center', padding: spacing.md, minHeight: 70, backgroundColor: colors.surface, borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.card },
    icon: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.small },
    ...
    quickEntryCard: { padding: spacing.md, backgroundColor: colors.surface, borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.card },
    ...
    triggerOptionActive: { backgroundColor: colors.primary, borderColor: colors.divider },
