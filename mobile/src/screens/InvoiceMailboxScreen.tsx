...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  heroIcon: { width: 64, height: 64, borderRadius: borderRadius.medium, backgroundColor: colors.primaryLight, borderWidth: borderWidth.thin, borderColor: colors.divider, alignItems: 'center', justifyContent: 'center', marginBottom: spacing.md },
  title: { fontSize: 22, fontWeight: '800', color: colors.textPrimary },
  subtitle: { fontSize: 13, lineHeight: 20, color: colors.textSecondary, textAlign: 'center', marginTop: spacing.sm },
  card: { backgroundColor: colors.surface, borderRadius: borderRadius.card, borderWidth: borderWidth.thin, borderColor: colors.divider, padding: spacing.lg, marginTop: spacing.lg, ...shadow.small },
  ...
  oauthPanel: { marginTop: spacing.md, padding: spacing.md, borderRadius: borderRadius.small, backgroundColor: colors.primaryLight, borderWidth: borderWidth.thin, borderColor: colors.divider },
  ...
  input: { minHeight: 48, borderWidth: borderWidth.thin, borderColor: colors.divider, borderRadius: borderRadius.input, backgroundColor: colors.background, color: colors.textPrimary, paddingHorizontal: spacing.md, fontSize: 15 },
  ...
  providerSelected: { backgroundColor: colors.primaryLight, borderColor: colors.divider },
  ...
  primaryButton: { minHeight: 48, borderRadius: borderRadius.button, borderWidth: borderWidth.thin, borderColor: colors.divider, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: spacing.xs, marginTop: spacing.md },
  primaryText: { color: '#FFFFFF', fontSize: 15, fontWeight: '800' },
  rowHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  statusText: { color: colors.textSecondary, fontSize: 13 },
  progressPanel: { marginTop: spacing.md, padding: spacing.md, borderRadius: borderRadius.small, backgroundColor: colors.primaryLight, borderWidth: borderWidth.thin, borderColor: colors.divider },
  ...
  centerEntry: { backgroundColor: colors.surface, borderRadius: borderRadius.card, borderWidth: borderWidth.thin, borderColor: colors.divider, padding: spacing.lg, marginTop: spacing.lg, flexDirection: 'row', alignItems: 'center', ...shadow.small },
  ...
  helpModal: { backgroundColor: colors.surface, borderRadius: borderRadius.card, padding: spacing.lg, borderWidth: borderWidth.thin, borderColor: colors.divider, ...shadow.large },
