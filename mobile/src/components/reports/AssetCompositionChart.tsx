...
export default function AssetCompositionChart({ categories, dateRange, totals }: { totals: LedgerFacts; categories: CashHistory['categories']; dateRange: string }) {
  ...
  return <View style={s.card}>
    <Text style={s.heading}>近 12 月分类构成</Text>
