...
import com.litenote.utils.UpdateNotificationHelper
...
class UpdateCheckWorker(
    ...
    private fun buildEndpoint(): String? {
        ...
        return "$baseUrl/app-version/check?currentVersion=${Uri.encode(BuildConfig.VERSION_NAME)}&platform=android"
    }
}
