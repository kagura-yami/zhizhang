...
const createStyles = (colors: ThemeColors) => ({
  ...StyleSheet.create({
    ...
    searchBox: { flex: 1, minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, paddingLeft: spacing.md, paddingRight: spacing.xs, borderWidth: borderWidth.thin, borderColor: colors.stroke, borderRadius: borderRadius.small, backgroundColor: colors.background },
    ...
    moreFilterButton: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center', borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.stroke, backgroundColor: colors.background },
    moreFilterButtonActive: { backgroundColor: colors.primary },
    quickFilters: { alignItems: 'center', paddingTop: spacing.sm },
    filterBtn: { minHeight: 40, justifyContent: 'center', paddingHorizontal: spacing.lg, borderRadius: borderRadius.small, marginRight: spacing.sm, backgroundColor: colors.surface, borderWidth: borderWidth.thin, borderColor: colors.stroke },
    ...
    smallOption: { minHeight: 40, justifyContent: 'center', paddingHorizontal: spacing.md, borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.stroke, backgroundColor: colors.background },
    ...
    amountFilterInput: { flex: 1, minHeight: 44, paddingHorizontal: spacing.md, borderRadius: borderRadius.small, borderWidth: borderWidth.thin, borderColor: colors.stroke, backgroundColor: colors.background, color: colors.textPrimary, fontSize: 13, fontWeight: '700' },
